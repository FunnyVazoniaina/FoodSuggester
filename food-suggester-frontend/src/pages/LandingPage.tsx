...
const LandingPage = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        "Plus besoin de chercher pendant des heures. Trouvez instantanément des recettes avec ce que vous avez sous la main.",
    },
    {
      icon: "mdi:leaf",
      title: "Réduisez le gaspillage",
      description:
        "Transformez vos restes en délicieux repas et contribuez à un mode de vie plus durable.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FFF0E5] via-[#fff5eb] to-[#FFF8F1] overflow-hidden">
      ...
      <nav className="relative z-50 px-6 py-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-3">
            ...
            <span className="text-2xl font-bold text-[#A0522D] font-serif">
              Food Suggester
            </span>
          </div>
          <div className="hidden md:flex items-center space-x-8">
            <a
              href="#features"
              className="text-[#4A4238] hover:text-[#FF6B35] transition-colors font-medium"
            >
              Fonctionnalités
            </a>
            <a
      ...
      {/* Hero Section */}
      <section
        className={`relative px-6 py-20 transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
      >
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-[#4A4238] leading-relaxed font-light max-w-lg">
                  Transformez vos ingrédients en délicieuses recettes grâce à
                  notre IA culinaire.
                  <span className="font-medium text-[#FF6B35]">
                    {" "}
                    Zéro gaspillage, 100% saveur.
                  </span>
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button
                  className="group border-2 border-[#FF6B35] text-[#FF6B35] hover:bg-[#FF6B35] hover:text-white px-8 py-4 rounded-2xl font-semibold text-lg transition-all duration-300"
                  onClick={() =>
                    window.open(
                      "https://www.youtube.com/watch?v=mr5f24gEuG0",
                      "_blank",
                    )
                  }
                >
              ...
              <div className="flex items-center gap-6 pt-8">
                <div className="flex -space-x-3">
                  {[1, 2, 3, 4].map((i) => (
                    <div
                      key={i}
                      className="w-12 h-12 bg-gradient-to-br from-[#FF6B35] to-[#E85826] rounded-full border-4 border-white shadow-lg flex items-center justify-center"
                    >
            ...
            <div className="relative">
              <div className="relative z-10 bg-white rounded-3xl shadow-2xl p-8 transform hover:rotate-0 transition-all duration-500 hover:scale-105 hover:shadow-3xl overflow-hidden group">
                {/* Background decoration */}
                <div className="absolute inset-0 bg-gradient-to-br from-[#FFF0E5]/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>

                {/* Content */}
                <div className="relative z-10">
                  {loadingRecipe ? (
                    <>
                      <div className="aspect-square bg-gray-200 rounded-2xl flex items-center justify-center mb-6 animate-pulse"></div>
                    ...
                    <>
                      ...
                      <div className="grid grid-cols-2 gap-2 mb-4">
                        ...
                        {dailyRecipe.calories && (
                          <div className="bg-[#FFF0E5] rounded-lg p-2">
                            ...
                            <p className="text-sm font-bold text-[#FF6B35]">
                              {Math.round(dailyRecipe.calories)}
                            </p>
                          </div>
                        )}
                      </div>
                      ...
                      {(dailyRecipe.protein ||
                        dailyRecipe.carbs ||
                        dailyRecipe.fat) && (
                        <div className="bg-gradient-to-r from-[#FFF0E5] to-[#fff5eb] rounded-lg p-3 mb-4 border border-[#FFE0CC]">
                          <div className="grid grid-cols-3 gap-2 text-center">
                            {dailyRecipe.protein && (
                              <div>
                                ...
                                <p className="text-sm font-bold text-[#A0522D]">
                                  {Math.round(dailyRecipe.protein)}g
                                </p>
                              </div>
                            )}
                            {dailyRecipe.carbs && (
                              <div>
                                ...
                                <p className="text-sm font-bold text-[#A0522D]">
                                  {Math.round(dailyRecipe.carbs)}g
                                </p>
                              </div>
                            )}
                            {dailyRecipe.fat && (
      ...
      <section
        id="features"
        className="px-6 py-20 bg-gradient-to-r from-[#FFF8F1] to-[#FFF0E5]"
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-[#4A4238] max-w-3xl mx-auto leading-relaxed">
              Une expérience culinaire révolutionnaire qui transforme votre
              façon de cuisiner au quotidien
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className="group bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-4 border border-[#FFF0E5]"
              >
                ...
                <h3 className="text-2xl font-bold text-[#A0522D] mb-4 font-serif">
                  {feature.title}
                </h3>
      ...
      <section className="px-6 py-20">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-[#A0522D] mb-4 font-serif italic">
            En chiffres
          </h2>
      ...
      <section
        id="testimonials"
        className="px-6 py-20 bg-gradient-to-r from-[#FFF0E5] to-[#fff5eb]"
      >
                ...
                {[...Array(testimonials[currentTestimonial].rating)].map(
                  (_, i) => (
                    <Icon
                      key={i}
                      icon="mdi:star"
                      className="w-8 h-8 text-[#FF6B35] mx-1"
                    />
                  ),
                )}
              </div>
                ...
                <button
                  ...
                  className={`w-4 h-4 rounded-full transition-all duration-300 ${
                    index === currentTestimonial
                      ? "bg-[#FF6B35] scale-125"
                      : "bg-[#FF6B35]/30 hover:bg-[#FF6B35]/60"
                  }`}
                />
              ))}
            </div>
            ...
            {[
              {
                ...
                title: "Listez",
                desc: "Entrez simplement les ingrédients disponibles dans votre frigo",
              },
              {
                icon: "mdi:magic-staff",
                title: "Découvrez",
                desc: "Notre IA génère instantanément des recettes personnalisées",
              },
              {
                icon: "mdi:heart",
                title: "Savourez",
                desc: "Cuisinez et dégustez des plats délicieux en famille",
              },
            ].map((step, index) => (
              <div key={index} className="text-center group">
                ...
                <p className="text-[#4A4238] leading-relaxed text-lg">
                  {step.desc}
                </p>
              </div>
            ))}
      ...
      <section className="px-6 py-20 bg-gradient-to-br from-[#A0522D] to-[#8B4513] text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl mb-10 opacity-90 leading-relaxed max-w-2xl mx-auto">
            Rejoignez des milliers de cuisiniers qui ont déjà transformé leur
            façon de cuisiner. Commencez votre aventure culinaire dès
            aujourd'hui.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            ...
            >
              <span className="flex items-center gap-3">
                <Icon
                  icon="mdi:chef-hat"
                  className="w-7 h-7 group-hover:bounce"
                />
                Créer mon compte
              </span>
            </button>
            ...
            <div className="flex items-center gap-3 text-white/80">
              ...
              <span className="font-medium">
                Gratuit • Sans engagement • 2 min d'inscription
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="text-white/70 leading-relaxed max-w-md">
              L'application qui transforme vos ingrédients en inspiration
              culinaire. Cuisinez malin, savourez mieux.
            </p>
          </div>
