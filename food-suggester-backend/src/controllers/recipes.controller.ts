...
export const suggestRecipes = async (req: Request, res: Response) => {
  ...
  if (userId) {
    await db.query(
      "INSERT INTO search_history (user_id, ingredients) VALUES (?, ?)",
      [userId, ingredients],
    );
  }
...
export const suggestRecipesWithDetails = async (
  req: Request,
  res: Response,
): Promise<void> => {
  try {
...
export const getDailyRecipeOfDay = async (
  req: Request,
  res: Response,
): Promise<void> => {
  try {
...
export const getRecipeOfDayByTag = async (
  req: Request,
  res: Response,
): Promise<void> => {
  try {
